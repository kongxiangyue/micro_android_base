package com.example.kong.account.dao;
...
public class PasswordDAO {
	...
	public PasswordDAO(Context context)// 定义构造函数
	{
	 ...
	 * @param Password
	 */
	public void add(Password tb_pwd) {
	 ...
	 * @param tb_pwd
	 */
	public void update(Password tb_pwd) {
		db = helper.getWritableDatabase();// 初始化SQLiteDatabase对象
		// 执行修改密码操作
	...
	public Password find() {
		...
		{
			// 将密码存储到Password类中
			return new Password(cursor.getString(cursor
